...
int get_profile_string(const char *profile, const char *AppName, const char *KeyName, char *KeyVal)
{
...
int main(int argc ,char* argv)
{
	...
	printf("server's ip =%s, port=%s\n", svr_ip, svr_port);

	printf("ip=%s, port=%s, user=%s, pw=%s, db_name=%s\n",ip, port, user, pw, db_name);
	return 0;
}
#endif
